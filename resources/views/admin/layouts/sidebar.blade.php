                                ...
                                @if(auth()->check()&& auth()->user()->role->name === 'doctor')
                                   <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="{{route('patients.today')}}" class="menu-item"> appointement for Today</a>
                                        <a href="{{route('prescribed.allmedicalrecord')}}" class="menu-item">other's days appointment</a>  
                                        <a href="{{route('prescribed.My_records')}}" class="menu-item">My records</a>                                                                          
                                        <a href="{{route('prescribed.shared')}}" class="menu-item">Shared medical record</a>                                       
                                        <a href="{{route('prescribed.request')}}" class="menu-item">request doctors for records</a>                                     
                                        <a href="{{route('prescribed.Other_records')}}" class="menu-item">Other records</a>                                     
                                    </div>
                                </div>
                                @endif
